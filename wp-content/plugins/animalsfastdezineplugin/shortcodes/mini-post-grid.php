 ...
 *
 */
if (!function_exists('mini_posts_grid_shortcode_mm')) {
    function mini_posts_grid_shortcode_mm($atts, $content = null, $shortcodename = '')
    {
    ...
    add_shortcode('mini_posts_grid_mm', 'mini_posts_grid_shortcode_mm');
